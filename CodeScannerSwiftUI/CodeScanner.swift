...
public struct CodeScannerView: UIViewControllerRepresentable {
    ...
    public class ScannerViewController: UIViewController {
       ...
       var delegate: ScannerCoordinator?
        ...
        override public func viewDidLoad() {
            ...
            previewLayer.frame = CGRect(x: 0, y: 0, width: 400, height: 400)//view.layer.bounds
    ...
    public var codeTypes = [AVMetadataObject.ObjectType.upce,
    ...
    public init(simulatedData: String = "", completion: @escaping (Result<String, ScanError>) -> Void) {
